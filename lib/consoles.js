...
exports.help = function () {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/dotmind/create-dotmind-app/issues/new')}
  `;
}

exports.example = function () {
  return `Example from https://github.com/dotmind/boilerplates-templates/tree/main/examples/ ${output.param('example-path')}`;
}
...
For example:
  ${chalk.cyan(program.name)} ${chalk.green('my-dotmind-app')}
  ${chalk.cyan(program.name)} ${chalk.cyan('--example custom-server')} ${chalk.green('custom-server-app')}
Run ${chalk.cyan(`${program.name} --help`)} to see all options.
`;
}

exports.missingServiceName = function () {
  return `
Please specify the service name:
  ${chalk.cyan(program.name)} ${chalk.green('<service-name>')}
For example:
  ${chalk.cyan(program.name)} ${chalk.green('my-service')}
Run ${chalk.cyan(`${program.name} --help`)} to see all options.
`;
}
...
Please specify the project example:
  ${chalk.cyan(program.name)} ${chalk.cyan('--example custom-server')} ${chalk.green('my-dotmind-app')}
`;
}
...
exports.start = function (projectName) {
  ...
  ${chalk.green('https://github.com/dotmind/create-dotmind-app/issues')}
`;
}
