...
exports.help = function () {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/dotmind/dotmind-boilerplate/issues/new')}
  `;
}

exports.example = function () {
  return `Example from https://github.com/dotmind/boilerplates/tree/main/examples/ ${output.param('example-path')}`;
}
